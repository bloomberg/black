...
class BlackTestCase(unittest.TestCase):
    ...
    def test_cython_parse_DEF_stmt(self) -> None:
        src_text, _ = read_data("cython_parse_tests/DEF_stmt.pyx")
        black.lib2to3_parse(src_text, {TargetVersion.CYTHON})

    def test_cython_parse_include_stmt(self) -> None:
        src_text, _ = read_data("cython_parse_tests/include_stmt.pyx")
        black.lib2to3_parse(src_text, {TargetVersion.CYTHON})

    def test_cython_parse_enumdef(self) -> None:
    ...
    def test_cython_parse_cdef_class(self) -> None:
        src_text, _ = read_data("cython_parse_tests/cdef_class.pyx")
        black.lib2to3_parse(src_text, {TargetVersion.CYTHON})

    def test_cython_parse_cdef_block(self) -> None:
    ...
    def test_cython_parse_fuseddef(self) -> None:
    ...
    def test_cython_parse_address_of(self) -> None:
        src_text, _ = read_data("cython_parse_tests/address_of.pyx")
        black.lib2to3_parse(src_text, {TargetVersion.CYTHON})

    def test_cython_parse_typecast(self) -> None:
    ...
    def test_cython_parse_new_expression(self) -> None:
        src_text, _ = read_data("cython_parse_tests/new_expression.pyx")
        black.lib2to3_parse(src_text, {TargetVersion.CYTHON})
    ...
    def test_cython_format_DEF_stmt(self) -> None:
        black.monkey_patch_cython_symbols()
        source, expected = read_data("cython_format_tests/DEF_stmt.pyx")
        actual = cyth_fs(source)
        self.assertFormatEqual(expected, actual)
        black.assert_stable(source, actual, cyth_mode)
        black.monkey_patch_python_symbols()
    ...
    def test_cython_format_include_stmt(self) -> None:
        black.monkey_patch_cython_symbols()
        source, expected = read_data("cython_format_tests/include_stmt.pyx")
        actual = cyth_fs(source)
        self.assertFormatEqual(expected, actual)
        black.assert_stable(source, actual, cyth_mode)
        black.monkey_patch_python_symbols()
